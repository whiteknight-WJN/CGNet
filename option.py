...
class BaseOption(object):
    def __init__(self):
        ...
        self.parser.add_argument('--batch_size', type=int, default=80, help='the number of batch_size')
        self.parser.add_argument('--dataset_name', type=str, default='aia2ha_new_unet_final_origin_raw_real', help='[Cityscapes, Custom]')
...
class TrainOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--n_epochs', type=int, default=400, help='how many epochs you want to train')
