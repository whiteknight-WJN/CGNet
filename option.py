...
class BaseOption(object):
    def __init__(self):
        ...
        self.parser.add_argument('--batch_size', type=int, default=24, help='the number of batch_size')
        self.parser.add_argument('--dataset_name', type=str, default='aia2ha_new_unet_origin_wjn', help='[Cityscapes, Custom]')
...
class TrainOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--flip', action='store_true', default=False, help='switch for flip input data')
        ...
        self.parser.add_argument('--iter_display', type=int, default=100)
        ...
        self.parser.add_argument('--n_epochs', type=int, default=500, help='how many epochs you want to train')
