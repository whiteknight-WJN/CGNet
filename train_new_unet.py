if __name__ == '__main__':
    ...
    from model_new_unet import Generator,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '0,1,2,3,4,6,7'

    DEVICE = torch.device('cuda:0')
    lr = opt.lr

    dataset = MyDataset1('../OE_SYNdataset','../train_new.txt')
    ...
    test_dataset = MyDataset1('../OE_SYNdataset','../test_new.txt')
    ...
    G=nn.DataParallel(G,device_ids=[0,1,2,3,4,6,7])
