if __name__ == '__main__':
    ...
    from model_new_unet_msec import Generator,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '1,2,3,4,5,7'
    ...
    test_dataset = MyDataset3('../../../../../data1/hongyang/OE_SYNdataset_new','../test_shai1.txt')
    ...
    G = nn.DataParallel(G,device_ids=[1,2,3,4,5,7])
