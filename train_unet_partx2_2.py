...
if __name__ == '__main__':
    ...
    from model_new_unet_sg_partx2 import Generator_partx2_1,Generator_partx2_2,Generator_partx2_3,Generator_partx2_4,Generator_partx2_5,Generator_partx2_6,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '3,4,5'
    ...
    G1 = Generator_partx2_6().to(DEVICE)
    ...
    G=nn.DataParallel(G1,device_ids=[3,4,5])
