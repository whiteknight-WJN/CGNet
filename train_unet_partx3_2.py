...
if __name__ == '__main__':
    ...
    from model_new_unet_sg_partx3 import Generator_partx3_2,Generator_partx3_3,Generator_partx3_4,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '3,5,6'
    ...
    G1 = Generator_partx3_3().to(DEVICE)
    ...
    G=nn.DataParallel(G1,device_ids=[3,5,6])
