import torch
from model_new_unet_in import Generator
...
output_dir = r'./result_in_att'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

G = Generator().cuda()
G_static=torch.load('./checkpoints/aia2ha_new_unet_in/Model/height_512/500_G.pt')
...
source_path='../OE_SYNdataset/'
testfile=open('../test_shai.txt','r')
...
for i in tqdm(testfile):
    ...
    imgfile=source_path+i.split()[0]+'/10.png'
    ...
    with torch.no_grad():
        ...
        savepath1 = output_dir + '/' + '%s_10_predict.png'%(i)
