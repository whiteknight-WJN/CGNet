...
class Manager(object):
    ...
    @staticmethod
    def report_loss1(package):
        print("Epoch: {} [{:.{prec}}%] Current_step: {}  G_loss: {:.{prec}}"
              .format(package['Epoch'],
                      package['current_step'] / package['total_step'] * 100,
                      package['current_step'],
                      package['G_loss'],
    ...
    def tensor2image(self, image_tensor):
        np_image = image_tensor.squeeze().cpu().float().numpy()[0]
        ...
        np_image = self.adjust_dynamic_range(np_image, drange_in=[-1., 1.]
                                             , drange_out=[0, 255])
