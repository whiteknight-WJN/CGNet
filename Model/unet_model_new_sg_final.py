...
class UNet_BA(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_BA, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
...
class UNet_xiao1(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_xiao1, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
        ...
        self.up1 = NORUp(1024+512, (512+256) // factor, bilinear)
        self.up2 = NORUp(512+256, (256+128) // factor, bilinear)
        self.up3 = NORUp(256+128, (128+64) // factor, bilinear)
        self.up4 = NORUp(128+64, 64+32, bilinear)
        self.outc = OutConv(64+32, n_classes)
        self.tanh=nn.Tanh()
...
class UNet_xiao2(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_xiao2, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
...
class UNet_xiao3(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_xiao3, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
...
if __name__ == '__main__':
    ...
    out=unet(input1)
    print(out.shape)
    model=HIBlock(64,128,0.2)
    input=torch.randn((2,64,160,160))
    output=model(input)
    print(output.shape)
    model=DRDB(64,3,12,3)
    output = model(input)
    print(output.shape)
