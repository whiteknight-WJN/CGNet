...
from unet_model_new_sg_final import UNet,UNet_xiao1,UNet_xiao2,UNet_xiao3,UNet_BA,UNet_IN
...
class Generator_X1(nn.Module):
    def __init__(self,):
        super(Generator_X1, self).__init__()

        self.stage2=UNet_xiao1(4,3)
    def forward(self, x0):
