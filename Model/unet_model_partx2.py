...
class UNet_PARTX2_1(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_PARTX2_1, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear

        self.inc = HIBlock(self.n_channels, 64,0)
        self.sgin = SG_IN(1,32)
        self.down1 = HIDown(64+32, 128)
        self.sgdown1 = SG_DOWN(32, 64)
        self.down2 = HIDown(128+64, 256)
        self.sgdown2 = SG_DOWN(64, 128)
...
class UNet_PARTX2_2(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_PARTX2_2, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
...
class UNet_PARTX2_3(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_PARTX2_3, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
    ...
    def forward(self, x):
        ...
        g = dmap
        b = dmap[:, 2:3, :, :]
        rb=torch.cat([g[:,1:2,:,:],g[:,3:4,:,:]],dim=1)
...
class UNet_PARTX2_4(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_PARTX2_4, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear

        self.inc = HIBlock(self.n_channels, 64,0)
        self.sgin = SG_IN(3,32)
        self.down1 = HIDown(64+32, 128)
        self.sgdown1 = SG_DOWN(32, 64)
        self.down2 = HIDown(128+64, 256)
        self.sgdown2 = SG_DOWN(64, 128)
    ...
    def forward(self, x):
        ...
        g = dmap
        b = dmap[:, 2:3, :, :]
        rb=torch.cat([r,g[:,1:2,:,:],g[:,3:4,:,:]],dim=1)
...
class UNet_PARTX2_5(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_PARTX2_5, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
    ...
    def forward(self, x):
        ...
        g = dmap
        b = dmap[:, 2:3, :, :]
        rb=torch.cat([b,g[:,1:2,:,:],g[:,3:4,:,:]],dim=1)
...
class UNet_PARTX2_6(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_PARTX2_6, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
    ...
    def forward(self, x):
        ...
        g = dmap
        b = dmap[:, 2:3, :, :]
        rb=torch.cat([r,b,0.5*(g[:,1:2,:,:]+g[:,3:4,:,:])],dim=1)
