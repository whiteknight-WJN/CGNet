...
from unet_model_partx2 import UNet_PARTX2_1,UNet_PARTX2_2,UNet_PARTX2_3,UNet_PARTX2_4,UNet_PARTX2_5,UNet_PARTX2_6
...
class Generator_partx2_1(nn.Module):
    def __init__(self,):
        super(Generator_partx2_1, self).__init__()

        self.stage2=UNet_PARTX2_1(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx2_2(nn.Module):
    def __init__(self,):
        super(Generator_partx2_2, self).__init__()

        self.stage2=UNet_PARTX2_2(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx2_3(nn.Module):
    def __init__(self,):
        super(Generator_partx2_3, self).__init__()

        self.stage2=UNet_PARTX2_3(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx2_4(nn.Module):
    def __init__(self,):
        super(Generator_partx2_4, self).__init__()

        self.stage2=UNet_PARTX2_4(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx2_5(nn.Module):
    def __init__(self,):
        super(Generator_partx2_5, self).__init__()

        self.stage2=UNet_PARTX2_5(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx2_6(nn.Module):
    def __init__(self,):
        super(Generator_partx2_6, self).__init__()

        self.stage2=UNet_PARTX2_6(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_X2(nn.Module):
    def __init__(self,):
        super(Generator_X2, self).__init__()

        self.stage2=UNet_xiao2(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_X3(nn.Module):
    def __init__(self,):
        super(Generator_X3, self).__init__()

        self.stage2=UNet_xiao3(4,3)
    def forward(self, x0):
...
class Generator_BA(nn.Module):
    def __init__(self,):
        ...
        self.stage2=UNet_BA(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_IN(nn.Module):
    def __init__(self,):
        super(Generator_IN, self).__init__()
