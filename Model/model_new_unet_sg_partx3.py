...
from unet_model_partx3 import UNet_PARTX3_2,UNet_PARTX3_3,UNet_PARTX3_4,UNet_PARTX3_5
...
class Generator_partx3_2(nn.Module):
    def __init__(self,):
        super(Generator_partx3_2, self).__init__()

        self.stage2=UNet_PARTX3_2(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx3_3(nn.Module):
    def __init__(self,):
        super(Generator_partx3_3, self).__init__()

        self.stage2=UNet_PARTX3_3(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx3_4(nn.Module):
    def __init__(self,):
        super(Generator_partx3_4, self).__init__()

        self.stage2=UNet_PARTX3_4(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx3_5(nn.Module):
    def __init__(self,):
        super(Generator_partx3_5, self).__init__()

        self.stage2=UNet_PARTX3_5(4,3)
    def forward(self, x0):
