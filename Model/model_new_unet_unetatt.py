...
from unet_model import UNet_att
...
class ChannelSELayer(nn.Module):
    ...
    def forward(self, input,input1):
        ...
        output_tensor = torch.mul(input1, fc_out_2.view(a, b, 1, 1))
...
class Generator1(nn.Module):
    def __init__(self,):
        ...
        self.final = Conv2d(32,48)

        self.sgr=ChannelSELayer(16)
        self.sgb=ChannelSELayer(16)
    ...
    def forward(self, x):
        ...
        out1=self.sgr(r_out,g_out)
        out2=self.sgb(b_out,g_out)
