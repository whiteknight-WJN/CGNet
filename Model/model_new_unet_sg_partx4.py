...
from unet_model_partx4 import UNet_PARTX4_1,UNet_PARTX4_2,UNet_PARTX4_3,UNet_PARTX4_4,UNet_PARTX4_5,UNet
...
class Generator_partx4_1(nn.Module):
    def __init__(self,):
        super(Generator_partx4_1, self).__init__()

        self.stage2=UNet_PARTX4_1(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx4_2(nn.Module):
    def __init__(self,):
        super(Generator_partx4_2, self).__init__()

        self.stage2=UNet_PARTX4_2(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx4_3(nn.Module):
    def __init__(self,):
        super(Generator_partx4_3, self).__init__()

        self.stage2=UNet_PARTX4_3(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx4_4(nn.Module):
    def __init__(self,):
        super(Generator_partx4_4, self).__init__()

        self.stage2=UNet_PARTX4_4(4,3)
    def forward(self, x0):
...
class Generator_partx4_5(nn.Module):
    def __init__(self,):
        super(Generator_partx4_5, self).__init__()

        self.stage2=UNet_PARTX4_5(4,3)
    def forward(self, x0):
