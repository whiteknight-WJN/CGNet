...
from unet_model_partx1 import UNet_PARTX1_1,UNet_PARTX1_2,UNet_PARTX1_3
...
class Generator_partx1_1(nn.Module):
    def __init__(self,):
        super(Generator_partx1_1, self).__init__()

        self.stage2=UNet_PARTX1_1(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx1_2(nn.Module):
    def __init__(self,):
        super(Generator_partx1_2, self).__init__()

        self.stage2=UNet_PARTX1_2(4,3)
    def forward(self, x0):

        out = self.stage2(x0)
        return out

class Generator_partx1_3(nn.Module):
    def __init__(self,):
        super(Generator_partx1_3, self).__init__()

        self.stage2=UNet_PARTX1_3(4,3)
    def forward(self, x0):
