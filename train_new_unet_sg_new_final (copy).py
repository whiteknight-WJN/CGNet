...
if __name__ == '__main__':
    ...
    from model_new_unet_sg_new_final import Generator,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '2,4,6,7'
    ...
    G_static = torch.load('./checkpoints/aia2ha_new_unet_new_sg_final_all/Model/height_512/480_G.pt')
    model_static = {k.replace('module.', ''): v for k, v in G_static.items()}
    # model_static.update(G_static)
    G1.load_state_dict(model_static)


    G=nn.DataParallel(G1,device_ids=[2,4,6,7])
