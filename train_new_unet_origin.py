if __name__ == '__main__':
    ...
    from model_new_unet_origin import Generator,Loss
    ...
    dataset = MyDataset1('../Over_Exposure/REAL_DATASET_NEW/', 'train_real.txt')
    ...
    # print(test_opt)
    # raise(ValueError)
    # test_dataset = MyDataset1('../../../../../data4/hongyang/REAL_DATASET_NEW', '../test_real.txt')
    test_dataset = MyDataset1('../../Over_Exposure/REAL_DATASET_NEW/', '../test_real.txt')
    ...
    # G_static=torch.load('./checkpoints/aia2ha_new_unet_origin_all/Model/height_512/400_G.pt')
