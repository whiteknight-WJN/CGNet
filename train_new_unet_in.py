if __name__ == '__main__':
    ...
    from model_new_unet_in import Generator,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '0,1,2,3,4,6'

    DEVICE = torch.device('cuda:0')
    lr = opt.lr

    dataset = MyDataset1('../../../../../data1/hongyang/OE_SYNdataset','../train_shai.txt')
    ...
    test_dataset = MyDataset1('../../../../../data1/hongyang/OE_SYNdataset','../test_shai.txt')
    ...
    G=nn.DataParallel(G1,device_ids=[0,1,2,3,4,6])
