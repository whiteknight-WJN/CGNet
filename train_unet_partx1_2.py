...
if __name__ == '__main__':
    ...
    from model_new_unet_sg_partx1 import Generator_partx1_1,Generator_partx1_2,Loss
    ...
    os.environ['CUDA_VISION_DEVICES'] = '0,1,2,3'
    ...
    G1 = Generator_partx1_2().to(DEVICE)
    ...
    G=nn.DataParallel(G1,device_ids=[0,1,2,3])
