...
import torch
from model_new_unet_origin_rgb import Generator
...
output_dir = r'./result_origin_rgb_mix'
...
for i in tqdm(testfile):
    imgfile=source_path+i.split()[0]+'/rgb3.png'
    ...
    with torch.no_grad():
        ...
        savepath1 = output_dir + '/' + '%s_3_predict.png'%(i)
