...
if __name__ == '__main__':
    ...
    from model_new_unet_sg_partx2 import Generator_partx2_1,Generator_partx2_2,Generator_partx2_3,Generator_partx2_4,Generator_partx2_6,Loss
    ...
    G=nn.DataParallel(G1,device_ids=[0,1])
